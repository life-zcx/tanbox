  ...
  return (
    <aside className="w-64 bg-white border-r border-gray-200 h-screen sticky top-0 p-5 flex flex-col justify-between shrink-0 z-30">
      ...
      <div className="space-y-3 pt-4 border-t border-gray-100">
        {/* Support Box */}
        <div className="bg-gray-50 border border-gray-200 rounded-2xl p-3.5 text-xs space-y-2">
          <p className="font-extrabold text-black uppercase tracking-wider text-[11px]">Служба поддержки</p>
          <div className="space-y-1.5 text-gray-600">
            <a href="tel:+77273551020" className="flex items-center gap-2 hover:text-black transition-colors font-semibold text-[11px]">
              <Phone className="w-3.5 h-3.5 text-black shrink-0" />
              <span>+7 (727) 355-10-20</span>
            </a>
            <a href="mailto:support@tanbox.kz" className="flex items-center gap-2 hover:text-black transition-colors font-semibold text-[11px]">
              <Mail className="w-3.5 h-3.5 text-black shrink-0" />
              <span>support@tanbox.kz</span>
            </a>
            <a href="https://t.me/tanbox_support" target="_blank" rel="noopener noreferrer" className="flex items-center gap-2 hover:text-black transition-colors font-semibold text-[11px]">
        ...
        {user && (
          <button
            onClick={onLogout}
            className="w-full flex items-center gap-3 px-3.5 py-2.5 rounded-xl text-xs font-extrabold text-red-600 hover:bg-red-50 transition-all active:scale-95"
          >
